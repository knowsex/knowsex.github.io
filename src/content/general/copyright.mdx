...
[中文](#版权许可) / [English(Machine Translation)](#LICENSE)

# 版权许可

本文编辑于 2024 年 4 月 27 日。
...
This article was edited on April 27, 2024.

## Content

The text part of the article on KnowSex.net allows you to use it under the following conditions. Not a single one can be omitted: 

1. attach a link to the original article.
2. not be used for commercial purposes.
3. identify the source as KnowSex.net.
4. do not violate the laws of the country or region in which you are using it.
...
For images, please refer to the *column* in the *Image Sources* section at the end of the article, and use them in accordance with the copyright requirements of the original author. 
...
2. not violate the laws of the country or region in which you are using it.
